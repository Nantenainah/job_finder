            ...
            <div className={`border rounded-md mt-9 p-2' ${styles.contenair}`}>
                ...
                <form action="post" className="flex justify-center items-center flex-col">
                    <div className="mt-4 mb-6">
                        ...
                        <input type="email" placeholder="votre e-mail" id="email" onChange={handleChange} name='email' className=" rounded-lg p-2.5 block text-sm focus:outline-none" />
                    </div>
                    <div className="mt-2 mb-6">
                        <label htmlFor='password' className="block mb-2 text-sm font-medium text-gray-400">Mots de passe</label>
                        <input type="password" placeholder="mots de passe" onChange={handleChange} id="password" name='password' className="rounded-lg p-2.5 block text-sm focus:outline-none" />
                    </div>
