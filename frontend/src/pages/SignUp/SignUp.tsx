            ...
            <div className={`'border rounded-md mt-9 p-2' ${s.contenair}`}>
                ...
                <form action="post" className="flex justify-center items-center flex-col">
                    <div className="mt-4 mb-6">
                        ...
                        <input type="email" placeholder="votre e-mail" onChange={handleChange} id="email" value={user.email} name='email' className={`rounded-lg p-2.5 block text-sm focus:outline-none ${s.email}`} />
                    </div>
                    <div className="mt-2 mb-6">
                        <label htmlFor='password' className="block mb-2 text-sm font-medium text-gray-400">Mots de passe</label>
                        <input type="password" placeholder="*****" value={user.password} onChange={handleChange} id="password" name='password' className={`rounded-lg p-2.5 block text-sm focus:outline-none ${s.password}`} />
                    </div>
                    <div className="mt-2 mb-6">
                        <label htmlFor='repassword' className="block mb-2 text-sm font-medium text-gray-400">confirme mots de passe</label>
                        <input type="password" placeholder="*****" value={user.repassword} onChange={handleChange} id="repassword" name='repassword' className={`rounded-lg p-2.5 block text-sm focus:outline-none ${s.password}`} />
                    </div>
